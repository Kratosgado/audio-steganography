...
export default function AudioSteganography() {
  ...
  const API_URL = "http://127.0.0.1:8000/upload"; //backed's endpoint
...
//   const API_URL = "http://127.0.0.1:8000/upload"; // Update with actual FastAPI endpoint
